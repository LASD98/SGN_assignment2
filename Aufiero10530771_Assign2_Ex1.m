...
% Assignment #2 - Guidance - Exercise 1 Uncertainty propagation
% Author: Luca Aufiero
% Personal code: 10530771
% Matricola MSc Degree: 232972
% Total expected execution time ~ 60 s
%
...
% Covariance Matrix for both satellites
...
% Trace position and velocity for Point 1
figure()
subplot(1,2,1)
...
% Collision warning
figure()
plot(tp,Dr_Lin,'-.g','LineWidth',2);
hold on
plot(tp,Dr_UT,'--b','LineWidth',2);
plot(tp,cov_sum_pos_Lin,'-.k','LineWidth',2)
plot(tp,cov_sum_pos_UT,'--r','LineWidth',2)
xlabel('Orbital Periods');
ylabel('[km]')
legend('LinCov $\Delta r$','UT $\Delta r$','LinCov 3$\sqrt{max(\lambda_i(P_{sum}))}$',...
    'UT 3$\sqrt{max(\lambda_i(P_{sum}))}$','interpreter','latex')
...
ylabel('[-]');
title('3$\sqrt{max(\lambda_i(P_{r,i}))}$ for Mango','Interpreter','Latex');
legend('LinCov','UT','MC');
...
xlabel('Orbital Period');
ylabel('[-]');
title('3$\sqrt{max(\lambda_i(P_{r,i}))}$ for Tango','Interpreter','Latex');
legend('LinCov','UT','MC');
...
xlabel('Orbital Period');
ylabel('[-]');
title('3$\sqrt{max(\lambda_i(P_{v,i}))}$ for Mango','Interpreter','Latex');
legend('LinCov','UT','MC');
...
xlabel('Orbital Period');
ylabel('[-]');
title('3$\sqrt{max(\lambda_i(P_{v,i}))}$ Tango','Interpreter','Latex');
legend('LinCov','UT','MC');
...
plot(mc_mean_lvlh_sat1(1,1),mc_mean_lvlh_sat1(2,1),'x','MarkerSize',15,'LineWidth',3)
plot(mc_mean_lvlh_sat1(1,4),mc_mean_lvlh_sat1(2,4),'x','MarkerSize',15,'LineWidth',3)
plot(mc_mean_lvlh_sat1(1,end),mc_mean_lvlh_sat1(2,end),'x','MarkerSize',15,'LineWidth',3)
...
legend('','','','mean at rev 1','mean at rev 4','mean at tf',...
    'Covariance at rev 1','Covariance at rev 4','Covariance at tf');
xlabel('x [km]');
ylabel('y [km]');
title('MC: Mango');
...
plot(mc_mean_lvlh_sat2(1,1),mc_mean_lvlh_sat2(2,1),'x','MarkerSize',15,'LineWidth',3)
plot(mc_mean_lvlh_sat2(1,4),mc_mean_lvlh_sat2(2,4),'x','MarkerSize',15,'LineWidth',3)
plot(mc_mean_lvlh_sat2(1,end),mc_mean_lvlh_sat2(2,end),'x','MarkerSize',15,'LineWidth',3)
...
plot(sigma_mean1_lvlh(1,1),sigma_mean1_lvlh(2,1),'x','MarkerSize',15,'LineWidth',3)
plot(sigma_mean1_lvlh(1,4),sigma_mean1_lvlh(2,4),'x','MarkerSize',15,'LineWidth',3)
plot(sigma_mean1_lvlh(1,end),sigma_mean1_lvlh(2,end),'x','MarkerSize',15,'LineWidth',3)
...
plot(sigma_mean2_lvlh(1,1),sigma_mean2_lvlh(2,1),'x','MarkerSize',15,'LineWidth',3)
plot(sigma_mean2_lvlh(1,4),sigma_mean2_lvlh(2,4),'x','MarkerSize',15,'LineWidth',3)
plot(sigma_mean2_lvlh(1,end),sigma_mean2_lvlh(2,end),'x','MarkerSize',15,'LineWidth',3)
...
plot(r_lin1(1,1),r_lin1(2,1),'x','MarkerSize',15,'LineWidth',3)
plot(r_lin1(1,4),r_lin1(2,4),'x','MarkerSize',15,'LineWidth',3)
plot(r_lin1(1,end),r_lin1(2,end),'x','MarkerSize',15,'LineWidth',3)
...
plot(r_lin2(1,1),r_lin2(2,1),'x','MarkerSize',15,'LineWidth',3)
plot(r_lin2(1,4),r_lin2(2,4),'x','MarkerSize',15,'LineWidth',3)
plot(r_lin2(1,end),r_lin2(2,end),'x','MarkerSize',15,'LineWidth',3)
...
% Comparisons between MC, UT and LinCov ellipses at tf
% rev 1
figure()
subplot(1,2,1)
hold on;
...
drawEllipse(sigma_mean1_lvlh(1:2,1), sigma_cov1_lvlh(1:2,1:2,1),3)
drawEllipse(r_lin1(1:2,1), P_lvlh_sat1(1:2,1:2,1),3)
legend('Propagated MC samples','MC mean','UT mean','LinCov mean',...
    'MC covariance','UT covariance','LinCov covariance');
title('Mango at rev 1');
xlabel('x [km]');
ylabel('y [km]');

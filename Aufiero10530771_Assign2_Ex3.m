...
% Assignment #2 - Guidance - Exercise 3 Sequential filters
% Author: Luca Aufiero
% Personal code: 10530771
% Matricola MSc Degree: 232972
% Total expected execution time ~ 40 s
%
...
i_visibility_noise_station22 = Station2.sat1.elevation_noise  > Station2.min_el;
...
% Measurements skyplot w/o noise
figure()
...
% Measurements skyplot with noise
figure()
skyplot(wrapTo360(Station2.sat1.azimuth_noise(i_visibility_noise_station22)),Station2.sat1.elevation_noise(i_visibility_noise_station22),MaskElevation=Station2.min_el); 
...
% Simulated relative measurements acquired by the Mango satellite through its FFRF subsystem 
figure()
scatter(Azimuth, Elevation,'b','filled')
xlabel('Azimuth with noise [deg]')
ylabel('Elevation with noise [deg]')
legend('Mango FFRF relative measurements');
...
%
% This function retrieves the measurements of Rho, Azimuth and Elevation of
...
%
% This function represents the Unscented Kalman Filter.
%
...
%
% This function computes the differences of measurements taking care of
...
%
%   OUTPUT: diff_meas: compute difference of measurement [3,1]
%
% Author: Luca Aufiero
%
